...
class ServiceRestore extends Seeder
{
    ...
    public function run()
    {
      ...
      $services = json_decode(str_replace('http:\/\/localhost\/upwork\/riggers-backend\/public\/api', 'http:\/\/localhost\/upwork\/riggers-backend\/public\/api', \Storage::disk('local')->get('bu\services.json')), true);
